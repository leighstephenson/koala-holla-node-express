...
1. They need the ability to add a Koala to the database. 
2. Make a form with the appropriate info. 
3. Save the koala in the database. Think about what data types you'll be needing for your table columns.  

4. They need the ability to mark a Koala ready for transfer. 
5. Each koala in your UI needs a button in that reads 'Ready for Transfer'. 
6. When the user clicks on the button, it should update the database for the specific Koala. 
7. The 'Ready for Transfer' button should only appear for Koalas that haven't yet been marked ready for transfer.
